...
def get_resonator_shape(
    ...
    shape.add_to_ground(nanogds.Rectangle(8000, 2250).translate(500, 2240))
    if extend_ground:
        shape.add_to_ground(
            gdspy.Polygon(
                [
    ...
    if add_ground_connection:
        shape.add_to_ground(nanogds.Rectangle(1500, 450).translate(2600, 1100))
        shape.add_to_ground(nanogds.Rectangle(450, 1500).translate(2600, 1100))
        shape.add_to_ground(nanogds.Rectangle(-1500, 450).translate(6400, 1100))
        shape.add_to_ground(nanogds.Rectangle(-450, 1500).translate(6400, 1100))
