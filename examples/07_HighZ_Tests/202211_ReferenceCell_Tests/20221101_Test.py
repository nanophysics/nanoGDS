...
#    ground_cell = gdspy.Cell("GROUND")
#    ground_cell.add(feedline._ground)
#    
#    outer_cell = gdspy.Cell("OUTER")
#    outer_cell.add(feedline._outer)
#    
#    center_cell = gdspy.Cell("CENTER")
#    center_cell.add(shape._center)
...
#    print(array)
    ...
    checking_array = np.asarray([[-0.5,-0.5],[-0.5,0.5], [0.5,-0.5], [0.5,0.5]])
    
    pos_checking_array = np.asarray([pos + checking_array for pos in array])
    
    print(pos_checking_array)
    
    print(feedline._ground)
